 ...
 *   offset 824-959: struct_offsets (struct_offsets_t, STRUCT_OFFSETS_LEN = 136 bytes)
 *   offset 960-1471: additional (char[ADDITIONAL_LEN], 512 bytes)
...
#define setup_additional_offset (setup_struct_offsets_offset + STRUCT_OFFSETS_LEN) /* offset: 960 */
#define setup_end (setup_additional_offset + ADDITIONAL_LEN)             /* offset: 1472 */
 #endif
